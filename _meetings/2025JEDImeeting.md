...
<div class="row">
    ...
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/JEDImeeting2025/sponsors/logo_COB.png" title="The Company of Biologists logo" class="img-fluid rounded z-depth-0" %}
    </div>
    <div class="col-sm mt-3 mt-md-0">
    {% include figure.liquid path="assets/img/JEDImeeting2025/sponsors/ICM_logo.png" title="example image" class="img-fluid rounded z-depth-0" %}
  </div>
</div>
<div class="row justify-content-sm-center">
